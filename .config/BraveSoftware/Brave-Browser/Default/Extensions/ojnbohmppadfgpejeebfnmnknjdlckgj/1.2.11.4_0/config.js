...
/** @typedef {{Enabled: boolean, Config: {EndpointConversation: string, EndpointMessageFeedback: string, EndpointConversationChatMessages: string, FeedbackTextField: string, FeedbackRatingField: string, FeedbackThumbsDown: string, FeedbackThumbsUp: string, GizmoCodePattern: string, GizmoMagicCreatePattern: string, UnselectPromptOnURLChange: boolean, EnablePromptSendQuota: boolean, EnableConversationMessagesModification: boolean, EnableTextDecoderMessagesFilter: boolean, EnableDuplicateStylesheetMonitor: boolean}}} PromptTemplatesConfig */
